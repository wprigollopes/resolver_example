...
class TaskRepository extends ServiceEntityRepository
{
     ...
     *
     * parent::__construct($registry, Task::class) says:
     * "This repository is responsible for the Task entity."
     */
    ...
    /**
     * Find all tasks with a specific status, ordered by creation date (newest first).
     *
